...
public class UserRegistrationValidation implements Validator {
    ...
    public void validate(Object command, Errors errors) {
        ...
        ValidationUtils.rejectIfEmptyOrWhitespace(errors, "Salary", "field.Salary.empty");
        ValidationUtils.rejectIfEmptyOrWhitespace(errors, "Worker_des", "field.Worker_des.empty");
...
//        }
        ...
        if (regBean.getRepassword() != null && !regBean.getRepassword().isEmpty()) {
            ...
            if (!regBean.getRepassword().equals(regBean.getPassword())) {
                errors.rejectValue("password", "repassword.error");
            }
        }
...
//          if (regBean.getUsername() != null && !regBean.getUsername().isEmpty()) {
//            logger.info("inside email validate section:::::::::::::");
//            if (service.getUserNameValidation(regBean.getUsername())) {               
//               errors.rejectValue("Username", "email.Username.error");
//             }
//            }
        ...
        if (regBean.getPhone() != null && !regBean.getPhone().isEmpty()) {
            ...
            if (!matcher.matches()) {
                errors.rejectValue("Phone", "Phone.pattern.error");
            } else {
