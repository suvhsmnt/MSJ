                        ...
                        <div class="row"> 
                            <c:forEach items="${All}" var="Log"> 
                                 <c:url value="Order.htm" var="Prod">           
                                        <c:param name="ID" value="${Log.ORDER_Divide_ID}"/>                               
                                    </c:url>
                                <div class="table-box opport-box">
                                    ...
                                    <div class="table-detail">
                                        <div class="member-info">
                                            <h4 class="m-t-0"><b>${Log.ORDER_Divide_ID}</b></h4>
                                            <p class="text-dark m-b-5"><b>Type</b> <span class="text-muted">${Log.TYPE}</span></p>
                                        </div>
                                    </div>                        				
