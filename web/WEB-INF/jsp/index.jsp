                            ...
                            <div class="col-sm-12">
                                <div class="card-box">
                                    ...
                                    <div class="row">
                                        ...
                                        <form:form action="index.htm"  method="post" class="form-horizontal group-border-dashed" commandName="RegistrationDetails" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-3">
                                                    <input type="password" class="form-control" name="repassword" required data-parsley-equalto="#pass2" placeholder="Re-Type Password" />
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <input data-parsley-type="digits" name="Phone" type="text" class="form-control" required placeholder="Enter only digits" title="enter valid no" />
                                                </div>
                                                <form:errors path="Phone" cssStyle="color:red"/>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-sm-3 control-label">Adhar *</label>
                                                <div class="col-sm-6">
                                                    <input data-parsley-type="number" name="ADHAR" type="text" class="form-control" required placeholder="Enter only numbers" />
                                                </div>
                                            ...
                                            <div class="form-group">
                                             ...
                                             <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <input data-parsley-type="digits" name="Salary" type="text" class="form-control" required placeholder="Enter only digits" title="enter valid no" />
                                                </div>
                                                <form:errors path="Phone" cssStyle="color:red"/>
                                            </div>
                                            ...
                                            <div  class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <select class="selectpicker" name="Worker_des" data-live-search="true" data-style="btn-white">
                                                        <option value="IW">INSIDE WORKER</option>
                                                        <option value="OW">OUTSIDE WORKER</option>
                                            ...
                                            <div class="form-group">
                                                <label class="col-sm-3 control-label">File style before button</label>
                                                <div class="col-sm-6">
