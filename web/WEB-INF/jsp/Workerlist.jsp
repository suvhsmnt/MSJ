<%-- 
    Document   : Worker_list
    Created on : Feb 13, 2018, 8:18:18 PM
    Author     : Suvh
--%>
                    ...
                    <div class="content">
                        <div class="module">
                            ...
                            <c:url value="Preview.htm" var="myURL">
                                <c:param name="name" value="${Log.phone}"/>
                                <c:param name="price" value="${Log.adhar}"/>
                                    ...
                                    <div class="span6">
                                        <div class="media user">
                                            <a class="media-avatar pull-left" href="#">
                                                <img src="/MsJwellery/myImage.htm?id=${Log.phone}">
                                            </a>
                                            <div class="media-body">
                                                <h3 class="media-title">
                                                    <c:out value="${Log.name}"/></h3>
                                                <p>
                                                    <small class="muted"><c:out value="${Log.adhar}"/></small></p>
